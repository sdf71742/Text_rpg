...
namespace WindowsFormsApp1
{
    public partial class Form2 : Form
    {
        ...
        public int visit = 0;
        public character ch;
        //public NPC npc; //npc가 있을 경우 추가
        public Form2(ref character character)
        {
            //NPC 있을 경우 추가
            ...
            //picture_npc.Image = slime.img; //npc 있을 경우 추가
            setting(character);
            item_btn_enable();
            act_btn_enable();
        ...
        public void setting(character character)
        {
            ...
            npc_name.Text = "";//npc 추가시 제거
            NPC_health.Text = "";//npc 추가시 제거
        ...
        private void leb_Click(object sender, EventArgs e)
        {
        ...
        {
            _1_test _1_= new _1_test(ref ch);
            this.Hide();
            _1_.ShowDialog();
        ...
        private void picture_npc_Click(object sender, EventArgs e)
        {
